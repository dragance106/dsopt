...
# Variety of expensive functions to test the implementation
...
# Retrieved March 13, 2024, from http://www.sfu.ca/~ssurjano/.
...
if __name__=="__main__":
    from main import dsopt

    # for i in range(5):
    #     best_value, best_point = dsopt(ackley,
    #                                    {'xx': (2, np.linspace(-32.77, 32.77, 6555))},
    #                                    max_evaluations=500,
    ...
    #                                    r=20,
    #                                    verbose_level=2)
    #     print(f'ackley2, run {i}, best value={best_value} for point: {best_point}')
    ...
    best_value, best_point = dsopt(simulate_desert_villa,
                                   ...
                                   r=20,
                                   verbose_level=3)
    print(f'simulate_desert_villa: best value={best_value}, best_point={best_point}')
    ...
    # NEXT STEP:
    # - instaliraj alternative za surogat optimizaciju (entmoot, rbfopt, pymoo+eppy):
    #   - pymoo za single-objective categorical variables wraps up around optuna
    #     (https://pymoo.org/customization/mixed.html),
    #     tako da pymoo mozda ni ne treba razmatrati
    #     eventualno, standardan jEPlus+EA umesto pymoo...
    #     mada moze jednostavno da se ostavi pymoo, kad vec imam uputstvo za categorical variables...
    #   - inace, optuna ima Gaussian process-based Bayesian optimisation (optuna.samplers.GPSampler),
    #     koji mozda moze da se koristi umesto RBFOpt?
